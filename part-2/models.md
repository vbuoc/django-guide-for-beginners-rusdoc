...
```Board.objects.all() <queryset [<board:="" board="" object="">, <board: board="" object="">]></board:></queryset>```
...
```from boards.models import Board Board.objects.all() <queryset [<board:="" django="">, <board: python="">]></board:></queryset>```
...
```Board.objects.get(name='Django')<board: django=""></board:>```
